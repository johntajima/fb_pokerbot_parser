...
class FbPokerbotParserTest < ActiveSupport::TestCase
  ...
  test "#hole_cards parses two cards with no space" do
    ...
    assert_equal ['10h', '10d'], msg.cards.fetch(:hero)
  end
  ...
  test "#hold_cards returns nothing if only 1 card" do
    ...
    assert_equal [], msg.cards.fetch(:hero, [])
  end
  ...
  test "#hold_cards returns two cards if more than 2 cards presented" do
    ...
    assert_equal ['10h', '5h'], msg.cards.fetch(:hero)
  end
  ...
  test "#blinds parses 10/20 properly" do
    ...
    assert_equal 10, msg.options[:blinds][:sb]
    assert_equal 20, msg.options[:blinds][:bb]
    assert_nil msg.options[:blinds][:ante]
  end

  test "#blinds parse 1000/2000/100 properly for tourneys" do
    msg = FbPokerbotParser::MessageParser.new(".test blinds 1000/2000/100")
    assert_equal 1000, msg.options[:blinds][:sb]
    assert_equal 2000, msg.options[:blinds][:bb]
    assert_equal 100, msg.options[:blinds][:ante]
  end
  ...
  test "#blinds parse 10/20/40/50 straddle properly for cash games" do
    ...
    assert_equal 1, msg.options[:blinds][:sb]
    assert_equal 2, msg.options[:blinds][:bb]
    assert_equal [4,8], msg.options[:blinds][:straddle]
  end
  ...
  test "#big_blind parses and sets bb and sb properly" do
    ...
    assert_equal 5, msg.options[:blinds][:bb]
    assert_equal 2, msg.options[:blinds][:sb]
  end
  ...
  test "#hero accepts hole cards and stack size options" do
    ...
    expected = {:stack => 200}
    assert_equal expected, msg.players.fetch(:hero)
    assert_equal ["Kd", "Ah"], msg.cards.fetch(:hero)
  end
  ...
  test "#flop accepts flop cards only" do
    ...
    assert_equal ["Ah", "Qh", "Jh"], msg.cards.fetch(:flop)
  end
  ...
  test "#turn accepts card" do
    ...
    assert_equal ["Ah"], msg.cards.fetch(:turn)
  end
  ...
  test "#river accepts card" do
    ...
    assert_equal ["Ah"], msg.cards.fetch(:river)
  end
